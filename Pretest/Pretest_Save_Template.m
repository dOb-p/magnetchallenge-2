...
file_save_name = fullfile(path_root_save, [Material,save_name,'.h5']);
...
h5create(file_save_name, '/Loss', size(Loss_test_all'));

h5write(file_save_name, '/B_seq', B_test_all');
h5write(file_save_name, '/H_seq', H_test_all');
h5write(file_save_name, '/T', T_test_all');
h5write(file_save_name, '/Loss', Loss_test_all');

% Saving H with partial infomration.
file_test_name = fullfile(path_root_save, [Material,test_name,'.h5']);
